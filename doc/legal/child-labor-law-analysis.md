# German Child Labor Law and Volunteer Participation at CCC Events
...
| Parameter | Coverage |
|-----------|----------|
| Events Covered | All CCC events (Congress, Camps, regional meetups) |
| Detail Level | Policy and legal analysis |
| Age Groups | All minors (under 13, 13-14, 15-17 years) |

### Primary Legal Sources

| Abbreviation | Full Title | Promulgation |
|--------------|------------|--------------|
...
**JArbSchG Full Note**:
Gesetz zum Schutze der arbeitenden Jugend [JArbSchG] [Youth Labor Protection Act], Apr. 12, 1976, BGBl. I at 965, as amended (Ger.), https://www.gesetze-im-internet.de/jarbschg/.

**KindArbSchV Full Note**:
Kinderarbeitsschutzverordnung [KindArbSchV] [Child Labor Protection Ordinance], Apr. 23, 1998, BGBl. I at 1508 (Ger.), https://www.gesetze-im-internet.de/kindarbschv/.
...
### 1.0 Scope of Application: Does JArbSchG Apply to Volunteer Work?
...
1. **Systematized Scheduling**: Volunteers sign up for specific shifts through Engelsystem, creating formalized commitments rather than spontaneous assistance.

2. **Reliance by the Organization**: CCC events depend on volunteer contributions to operate; the organization relies on commitments being honored.

3. **Structured Integration**: Volunteer activities are integrated into the event's operational structure with defined tasks, responsibilities, and supervision.

4. **Tracking and Credit Systems**: Engelsystem tracks hours worked and applies multipliers for certain shifts, indicating a quasi-employment-like relationship.

5. **Not "Occasional"**: Regular scheduled shifts during a multi-day event do not qualify as "gelegentlich" (occasional) assistance.

Accordingly, organized volunteer work via Engelsystem constitutes "Beschäftigung" within the meaning of JArbSchG § 1 Abs. 1 Nr. 3 and does not fall within the § 1 Abs. 2 Nr. 1 a) exception. This conclusion is reinforced by the existence of KindArbSchV § 2 Abs. 1 Nr. 5, which specifically regulates activities at non-commercial events of associations—a provision that would be unnecessary if such activities were categorically excluded from the law's scope.

The consequence of this analysis is that JArbSchG applies to volunteer activities at CCC events, making compliance with its provisions (including the KindArbSchV exceptions) mandatory.
...
> [...]
>
> (3) Das Verbot des Absatzes 1 gilt ferner nicht für die Beschäftigung von Kindern, soweit sie nach § 6 bewilligt oder nach den §§ 7 bis 7b gestattet ist.
...
> Eine Beschäftigung mit Arbeiten nach Absatz 1 Nr. 3 ist nicht leicht und für Kinder über 13 Jahre und vollzeitschulpflichtige Jugendliche nicht geeignet, wenn sie
>
> 1. mit einer manuellen Handhabung von Lasten verbunden ist, die regelmäßig das maximale Lastgewicht von 7,5 kg oder gelegentlich das maximale Lastgewicht von 10 kg überschreiten,
>
...
## 2. Application to CCC Events

### 2.1 Corporate Structure and KindArbSchV § 2 Nr. 5

The Chaos Computer Club e.V. is a registered association (*eingetragener Verein*) under German law, registered with the Amtsgericht Hamburg.[^ccc-ev-registration] As a "Verein," CCC e.V. falls within the organizational categories enumerated in KindArbSchV § 2 Abs. 1 Nr. 5.[^kindarbschv-2-1-5-verein]

The Chaos Communication Congress is operationally conducted by CCC Veranstaltungs GmbH, a limited liability company (*Gesellschaft mit beschränkter Haftung*) that is a wholly-owned subsidiary of CCC e.V. This corporate structure raises the question of whether the KindArbSchV exception applies when the event operator is a GmbH rather than the Verein itself.

KindArbSchV § 2 Abs. 1 Nr. 5 permits activities at "non-commercial campaigns and events of [...] associations" (*nichtgewerbliche Aktionen und Veranstaltungen der [...] Vereine*). The statutory language refers to events "of" associations, not events "operated by" associations. Where a wholly-owned subsidiary conducts events on behalf of and in furtherance of the parent association's charitable purposes, those events retain their character as "Veranstaltungen des Vereins." The GmbH functions as an operational vehicle for the Verein's activities rather than as an independent commercial enterprise.

The question of whether CCC events constitute "non-commercial" (*nichtgewerblich*) activities requires examination of purpose rather than legal form. Commercial activity (*gewerblich*) in German law typically requires the pursuit of profit through sustained business activity.[^hgb-1] CCC e.V. is a non-profit organization pursuing charitable purposes (*gemeinnützige Zwecke*), and its events—including those operationally conducted through the GmbH—are organized to advance these purposes rather than to generate profit.[^ccc-satzung] The GmbH's legal form as a commercial entity (*Handelsgesellschaft*) does not convert the events into commercial activities where the GmbH does not pursue independent profit-seeking but rather serves as an operational arm of the charitable association.
...
Herald activities (*Herald*) involve announcing talks and introducing speakers. These activities are similarly light and carry no physical or psychological risks inappropriate for minors. They are suitable.

Translation support activities involve providing language assistance to attendees. These activities present no concerns under the suitability standard.
...
Supervision by responsible adults must be provided throughout the shift. Emergency protocols must be in place for situations involving minor volunteers.
...
Parental consent remains prudent practice for volunteers under 18, though the legal requirement is less explicit than for child employment.

---

## 4. Organizational Requirements for CCC

### 4.1 Parental Consent

All minor volunteers should provide documented parental consent prior to shift assignment. The consent documentation should include the minor's name and date of birth, identification of the event(s) covered, specification of permitted activity types, acknowledgment of time restrictions applicable to the minor's age category, guardian contact information for emergencies, and signature of a legal guardian.

### 4.2 Age Verification

CCC must implement procedures to verify the age of volunteer applicants. Self-reported birthdates should be confirmed through parental consent documentation. For particularly sensitive determinations (e.g., whether a 15-year-old remains subject to Vollzeitschulpflicht), additional verification may be appropriate.

### 4.3 Activity Classification

Each angel type in Engelsystem should be classified according to suitability for minor volunteers. This classification should distinguish between activities suitable for all minors, activities suitable only for adolescents not subject to compulsory schooling, and activities unsuitable for any minor.

### 4.4 Time Monitoring

The system should track cumulative daily volunteer hours for minor volunteers and prevent signup for shifts that would exceed applicable limits. Time restriction enforcement should account for the different limits applicable to children (2 hours), school-age adolescents (2 hours), and other adolescents (8 hours).

### 4.5 Supervision

Each shift involving minor volunteers should have a designated adult supervisor. Check-in and check-out procedures should document minor attendance. Emergency contact procedures should be established and communicated to all supervisors working with minors.

### 4.6 Documentation

CCC should maintain parental consent forms, age verification records, shift records for minor volunteers, activity classification documentation, and any incident reports. These records serve compliance verification purposes and should be retained for at least three years.
...
Risk mitigation should focus on clear classification of angel types by age suitability, system-enforced time restrictions based on verified age, mandatory parental consent workflow with age verification, supervisor training on age-related restrictions, documented check-in and check-out procedures for minor volunteers, and regular review of activity classifications against evolving event operations.

---

## 6. Conclusion

The threshold analysis confirms that JArbSchG applies to organized volunteer work at CCC events. While the law excludes "minor occasional assistance from courtesy" (§ 1 Abs. 2 Nr. 1 a)), organized volunteer activities via Engelsystem—with scheduled shifts, formalized commitments, and operational integration—constitute "Beschäftigung" within the meaning of § 1 Abs. 1 Nr. 3. This makes compliance with the law's provisions mandatory.

Volunteer participation by minors at CCC events is legally permissible under the KindArbSchV § 2 Abs. 1 Nr. 5 exception for activities at non-commercial events of registered associations. Implementation requires attention to age-specific restrictions on activities, working hours, and time of day, as well as organizational measures including parental consent, supervision, and documentation.

Children under 13 cannot volunteer under any circumstance. Children 13-14 and school-age adolescents 15-17 may volunteer for up to 2 hours per day between 8:00 and 18:00 in light and suitable activities. Adolescents 15-17 who have completed compulsory schooling may volunteer for up to 8 hours per day between 6:00 and 20:00, with somewhat broader activity options.

A structured "Junior Angel" program implementing these requirements would enable meaningful volunteer participation by the next generation of the CCC community while ensuring compliance with German youth labor protection law.
...
Jugendschutzgesetz [JuSchG] [Youth Protection Act]. July 23, 2002. BGBl. I at 2730, as amended (Ger.). https://www.gesetze-im-internet.de/juschg/.
